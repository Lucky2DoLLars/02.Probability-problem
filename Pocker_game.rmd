...
포커 게임에서 가능한 패는 'Royal flush', 'Straight flush', 'Four of a kind', 'Full house', 'Flush', 'Straight', 'Three of a kind', 'Two pair', 'One pair', 'No pair' 으로 구성되어 있다. 이 코드는 포거 게임의 각 패의 확률을 몬테카를로(Monte-carlo)방법을 이용하여 추정하는 것이다.
...
## 몬테카를로 방법
포커 게임을 $10^6$ 번 반복하여 각 패가 나올 확률을 추정한다.
```{r}  
